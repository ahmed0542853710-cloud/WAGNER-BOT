...
module.exports = {
    ...
    async execute(member) {
        ...
        try {
            ...
            // رابط صورة العضو بشكل مضمون وواضح
            const userAvatar = member.user.displayAvatarURL({ extension: 'png', forceStatic: false, size: 512 });
            ...
            const welcomeEmbed = new EmbedBuilder()
                ...
                .setFooter({ 
                    ...
                    iconURL: userAvatar // 👈 استخدام الرابط المباشر
                })
                .setTimestamp();
